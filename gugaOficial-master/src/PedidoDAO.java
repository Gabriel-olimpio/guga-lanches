...
public class PedidoDAO {
    public void salvarPedido(Pedido pedido) throws SQLException {
        String sqlPedido = "INSERT INTO gugapd.pedidos (cliente_id, forma_pagamento, tipo_consumo, valor_total) VALUES (?, ?, ?, ?)";
        String sqlItens = "INSERT INTO gugapd.itens_pedido (pedido_id, produto_id, quantidade, subtotal) VALUES (?, ?, ?, ?)";
